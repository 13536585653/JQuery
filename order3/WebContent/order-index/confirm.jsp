...
<div class="container-fluid" style="width: 1000px;">
    <div class="msg2" >
        <span class="bb-right"><a href="#" style="color: #666">首页</a></span>
       <p> <b>确认收货地址 </b>
        <input type="button" class="btn btn-default" id="btn-update" value="修改收货地址"></p>
    </div>
    <p style="margin-left: 30px;"><strong><span>收货地址:</span></strong><span>广东省珠海市斗门区白蕉南路南方it学院</span></p>
 </div>
    <center>
...
<table width="1000px;">
            ...
            <tr class="photo font" style="background-color: #fbfcff;text-align: center;border-top:1px dotted #b2d1f1 ">
                <td width="25%">
                    <div class="photo1">
                        <img src="cai/${map.m_img }" style="cursor: pointer;margin-right: 17px width: 60px;height: 60px;" >
                    </div>
                 <div class="left">
                    <a href="#" style="left: 50px;top:20px; font-size:20px" name="">${map.m_name }</a>
                 </div>
                    <div class="left" style="font-size:10px">时间：卖家承诺72小时之内发货</div>
                </td>
                <td><span></span></td>
                <td><span style="position: relative; font-size:20px">${map.m_price }￥</span></td>
                <td><span  style="position: relative;font-size:20px">${map.num }</span></td>
                <td><span style="position: relative;font-size:20px">活动打折</span></td>
                <td ><span  style="position: relative;font-size:20px"><fmt:parseNumber type="number" value="${ map.m_price*map.num}"  var="money"/><c:out value="${money}"></c:out></span>
                
                	<input type="hidden" name="id" value="${map.id}">
                	<input type="hidden" name="num" value="${map.num}">
                	<input type="hidden" name="price" value="${map.m_price*map.num }">
                </td>
...
<table   width="1000px" style="background-color: #f2f7ff;border-bottom: dotted 1px #b2d1f1;font-size: 13px;">
            ...
            <tr>
                <td>
                    <div style="margin-left: 25px">发货时间：卖家承诺在买家付款后10分钟<a href="#">配送</a>
                    </div></td>
            </tr>
            <tr>
            <td>
                <span class="bb-right" style="color: black;">合计(含运费)￥
                <font style="color: #ff2200;font-size:20px">${map.m_price*map.num }</font></span>
            </td>
             </tr>
</table>
...
<div id="sub">
            <div style="margin-top: 10px;">
                <div class="bb-right" style="color: #ff6600;font-size: 26px;">${map.m_price*map.num }</div>
            ...
            <div style="margin-top: 60px;margin-bottom: 50px">
                <div id="address" class="bb-right">广东省珠海市斗门区白蕉南路南方it学院</div>
                <b class="bb-right">寄送至：</b>
            </div>

            <div style="background: red;margin-top: 100px">
                <div class="bb-right">张三</div>
                <b class="bb-right">收货人：</b>
            </div>
   </div><!---sub-->
        <div style="margin-left: 600px;">
            <div class="bb-right">
                <input id="submit" class="btn btn-default" style="font-weight:700;color:#fff;width: 182px;height: 40px;background: #ff9a00;border: 0px;-webkit-border-radius: 0px;" type="button" value="提交订单"></div>
