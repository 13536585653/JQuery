...
(function(a){a(document).ready(function(){
	...
	a.supersized=function(b){var c="#supersized",
	d=this;d.$el=a(c);d.el=c;vars=a.supersized.vars;d.$el.data("supersized",d);
								...
								d._start=function(){
									...
									if(d.options.performance==3){
										d.$el.addClass("speed")
											...
											arr=d.options.slides;for(var h,m,k=arr.length;
											k;
											h=parseInt(Math.random()*k),m=arr[--k],arr[k]=arr[h],arr[h]=m){}
										...
										if(d.options.slides.length>1){
											if(d.options.slides.length>2){
												...
												d.options.slideshow=0}g=(api.getField("url"))?"href='"+api.getField("url")+"'":"";
																...
																a(document.documentElement).keyup(function(e){
																	...
																	if((e.keyCode==37)||(e.keyCode==40)){
																		...
																		a(d.el).hover(function(){
																			if(vars.in_animation){
																				return false}vars.hover_pause=true;
																				if(!vars.is_paused){
